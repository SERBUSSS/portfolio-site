// formFunctionality.js - Handles form validation, interaction, and submission

document.addEventListener('DOMContentLoaded', function() {
    // Check if formAnimation is available
    if (!window.formAnimation) {
      console.error('formAnimation module is required for form functionality');
      return;
    }
    ...
    function init() {
      // Setup textarea expandable editing
      initializeTextareas();
    ...
    function initializeOptionalQuestion() {
      ...
      const optionalQuestionContainer = document.querySelector('.question-container:last-of-type');
      ...
      if (showQuestionButton && hideQuestionButton && optionalQuestionContainer) {
        ...
        showQuestionButton.addEventListener('click', function() {
          ...
          const textarea = optionalQuestionContainer.querySelector('textarea');
          if (textarea) {
            textarea.focus();
          }
        });
