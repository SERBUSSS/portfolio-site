  ...
  'project-2': {
    ...
    cards: {
      desktop: [
        ...
        'Brand logo and identity design',
        'Typography selection',
        'Product page low-fidelity design, key sections (1)',
        'Product page low-fidelity design, key sections (2)',
        'Product page low-fidelity design, key sections (3)',
        'Product page low-fidelity design, key sections (4)',
        'Product page low-fidelity design, key sections (5)',
        'Product page high-fidelity design, key sections (1)',
        'Product page high-fidelity design, key sections (2)',
        'Product page high-fidelity design, key sections (3)',
        'Product page high-fidelity design, key sections (4)',
        'Product page high-fidelity design, key sections (5)',
        'Product page high-fidelity design, key sections (6)',
        'Product page high-fidelity design, key sections (7)',
        'Enhanced product creative to boost cart value',
        'Pre-order product creative design',
        'Referral program banner design'
      ],
      mobile: [
        null, // Index 0 - device specific instructions
        'Brand logomark',
  ...
  'project-3': {
    ...
    cards: {
      desktop: [
        ...
        'Height Enhancement Marketing Campaign (5)',
        ...
        'Strength Enhancement Marketing Campaign (5)'
      ],
      mobile: [
        null, // Index 0 - device specific instructions
        'Header Navigation Menu Enhancement',
