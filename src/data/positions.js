const cardPositions = {
    'project-1': {
        desktop: [
            { x: '-20', y: '-20', rotation: -30, scale: 0.4, opacity: 1 },
            { x: '0', y: '-25', rotation: 0, scale: 0.4, opacity: 1 },
            { x: '20', y: '-20', rotation: 30, scale: 0.4, opacity: 1 },
            { x: '25', y: '0', rotation: 25, scale: 0.4, opacity: 1 },
            { x: '20', y: '20', rotation: 20, scale: 0.42, opacity: 1 },
            { x: '0', y: '25', rotation: 0, scale: 0.41, opacity: 1 },
            { x: '-20', y: '20', rotation: -20, scale: 0.48, opacity: 1 },
            { x: '-25', y: '0', rotation: -25, scale: 0.4, opacity: 1 },
            { x: '-10', y: '-10', rotation: -35, scale: 0.42, opacity: 1 },
            { x: '10', y: '-10', rotation: 35, scale: 0.49, opacity: 1 },
            { x: '15', y: '5', rotation: 22, scale: 0.4, opacity: 1 },
            { x: '5', y: '15', rotation: 10, scale: 0.4, opacity: 1 },
            { x: '-5', y: '15', rotation: -10, scale: 0.42, opacity: 1 },
            { x: '-15', y: '5', rotation: -22, scale: 0.4, opacity: 1 },
            { x: '-5', y: '-15', rotation: -28, scale: 0.48, opacity: 1 },
            { x: '5', y: '-15', rotation: 28, scale: 0.4, opacity: 1 },
            { x: '0', y: '10', rotation: 0, scale: 0.4, opacity: 1 }
        ],
        mobile: [
